			...
			<div class="card-body">
				<form action="updateCat" method="post">
					<div hidden class="form-group">
						<label class="control-label">ID Categorie :</label> <input type="text" name="id" class="form-control" value="${categorie.idCat}" />
					</div>
					<div class="form-group">
						<label class="control-label">Nom Catégorie :</label> <input type="text" name="nom" class="form-control" value="${categorie.nomCat}" />
					</div>
					<div class="form-group">
